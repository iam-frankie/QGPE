...
public class Pattern2 implements Serializable {
    ...
    public HashSet<Integer> objectIdSet;
     ...
     *
     */
    public Pattern2(int[] objects, int[] timestamps) {
        initialize();
        for (int i : objects) {
            objectIdSet.add(i);
        }
    ...
    public Pattern2(Iterable<Integer> object_set, Iterable<Integer> timestamps) {
        initialize();
        for (int i : object_set) {
            objectIdSet.add(i);
        }
        for (int t : timestamps) {
            insertTime(t);
     ...
     */
    public void insertObject(int objectId) {
