...
public class loadHDFS {
    public static void writeRes(Map<String, Set<Long>> neighborIdsMap, String num) throws Exception {
        String hdfsUri = "hdfs://amax:9000";
        String hdfsPath = "hdfs://amax:9000//comovement/result/pattern"+num+".json";
