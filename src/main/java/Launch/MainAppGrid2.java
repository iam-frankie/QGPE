...
public class MainAppGrid2 {
        public static void main(String[] args) throws Exception {
                ...
                int testTime = AppProperties.getProperty("test_time") == null ? 0
                                : Integer.parseInt(AppProperties.getProperty("test_time"));
                int parallelism = 1;
                int partitionNum = 2;
                ...
                int SlidingWinndowSize = ((K / L) - 1) * (G - 1) + K + L - 1;
                ...
                DataStream<SnapShot> snapshotStream = env
                                .addSource(new LocalSnapshotSource(hdfs_uri, snapshotRootPath, isTest, testTime,
                                                TransGap, isConstrainTime, StartNo, StopNo))
                ...
                // .map(new KdTreePartitioningFunction(partitionNum, epsilon,
                // ConversionFactor));
                ...
                // todo 2-2 基于Grid-QUAD-tree的流式聚类方法
                System.out.println("窗口大小为:" + SlidingWinndowSize
                                + "--------------------------------------------------------------------------");
